...
* Follow instructions in the [EventTextWikipediaDumper](https://github.com/anonymoussubmissions94/EventTextWikipediaDumper) to run [MWDumper](https://www.mediawiki.org/wiki/Manual:MWDumper) and get Wikipedia articles of events in .ndjson file format. Place the resulting files into ```data\event_articles```in the project folder.
